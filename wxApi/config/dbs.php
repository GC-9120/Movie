    ...
    'tables' => array(
        ...
        '__default__' => array(                     // 固定的系统标志，不能修改！
            ...
            'map' => array(                         // 数据库统一默认存储路由
                array('db' => 'db_mac_cms'),         // db_master对应前面servers.db_master配置，须对应！
            ),
        ),
