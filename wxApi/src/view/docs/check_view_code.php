...
$semanticPath = '/wxApi/public/semantic/'; // 本地
?>
...
<head>
    ...
    <link rel="icon" href="/wxApi/public/favicon.ico" type="image/x-icon" />

    <script src="/wxApi/public/static/jquery.min.js"></script>
    <script src="/wxApi/public/static/jquery.cookie.min.js"></script>
