<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:58:"/www/wwwroot/maccms/application/admin/view/user/index.html";i:1603762995;s:59:"/www/wwwroot/maccms/application/admin/view/public/head.html";i:1603093946;s:59:"/www/wwwroot/maccms/application/admin/view/public/foot.html";i:1603093946;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <form class="layui-form " method="post" id="pageListForm">
        <table class="layui-table" lay-size="sm">
            ...
            <tr>
                ...
                <td>
                    <img src="<?php echo $vo['user_portrait']; ?>" style="width:40rpx;height:40px;border-radius: 50%;"/>
                ...
                <td><?php echo $vo['user_last_login_ip']; ?></td>
                <td><?php echo mac_day($vo['user_login_time'],color); ?></td>
                <td><?php echo $vo['user_login_ip']; ?></td>
                <td><?php echo $vo['user_portrait_thumb']; ?></td>
